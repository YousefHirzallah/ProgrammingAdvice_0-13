...
int main (void)
{
    cls_address Yousef_Adress("Jordan", "Amman", "7171", "1234");
    Yousef_Adress.ft_print();
    cls_address Yousef_Adress_Add("Mohammad Alhajjaj Street/Shafa Badran", "CG 923", "7171", "5555");
    Yousef_Adress_Add.ft_print();
