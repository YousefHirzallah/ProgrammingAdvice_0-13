...
int main (void)
{
    clsProgrammer    programmer_obj1(23, "Yousef", "Hirzallah", "Yousef.hirzallah@gmail.com", "07983178312",
    ...
    programmer_obj1.ft_send_sms("Please vote for Yousef Hirzallah in Amman elections.\nThank you <3.");
