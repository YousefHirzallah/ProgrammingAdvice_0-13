...
int main (void)
{
    cls_address Yousef_specific_add("Mohammad Alhajjaj Street/Shafa Badran", "CG 923", "7171", "5555");
    Yousef_specific_add.ft_print();
    
    cls_address cpy_Yousef_address_cls = Yousef_specific_add;
/*
...
*/
    cls_address cpy_Yousef_address_cls2 = Yousef_specific_add;
    cpy_Yousef_address_cls2.ft_print();
