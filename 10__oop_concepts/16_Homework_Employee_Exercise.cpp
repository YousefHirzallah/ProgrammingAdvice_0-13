...
int main (void)
{
    cls_employee  employee1_obj(19, "Yousef", "Hirzallah", "Software Engineer & Developer",
								 "Yousefhirza@gmail.com", "0792002831", 2300.9688, "IT Department");

    employee1_obj.ft_print_employee_info();
    employee1_obj.ft_send_email("Boss; I want an increase in my salary", "Hello Boss,\nI am Yousef Omar, I am sending to you because i have increase in my performance and i am doing too good job so i would like to suggest if you can give me increase in my salary, \nThanks\nYousef Hirzallah.");
    employee1_obj.ft_send_sms("Please vote for Yousef Hirzallah in Amman elections.\nThank you <3.");
    return (0);
}