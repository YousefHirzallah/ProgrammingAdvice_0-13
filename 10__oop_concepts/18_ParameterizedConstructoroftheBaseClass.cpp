...
int main (void)
{
    cls_employee    employee1(23, "Yousef", "Hirzallah", "Yousef.hirzallah@gmail.com", "07983178312",
    ...
    employee1.ft_send_sms("Please vote for Yousef Hirzallah in Amman elections.\nThank you <3.");
